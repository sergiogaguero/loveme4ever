...
var CONTRACT_NAME = undefined || 'loveme4ever.testnet';
...
function updateUI() {
  if (!window.walletConnection.getAccountId()) {
    ...
    contract.get_message({
      key: window.walletConnection.getAccountId()
    ...
    document.querySelector('#getMessage').addEventListener('click', function () {
